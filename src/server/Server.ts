...
export class Server implements OnDestroy {
    ...
    public async init(additionalRouteClasses?: Array<any>): Promise<void> {
        ...
        this.logger.info(`Initializing Beepo server on ${environment.host}:${environment.port}`);
    ...
    private start(): void {
        ...
        this.logger.info(`Beepo is listening on ${this.httpServer.info.uri}`);
    }

    public async onDestroy(): Promise<void> {
        this.logger.warn(`Beepo server is stopping`);
